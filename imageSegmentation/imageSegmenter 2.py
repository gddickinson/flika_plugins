...
class ImageSegmenter:
    ...
    def display_results(self, res, image):
        ...
        self.result_win = Window(res_image, 'Result')
...
def gui():
    ...
    try:
        open_file('/Users/george/Data/puffDetect/simulatedPuffs_max.tif')
        test = open_file('/Users/george/Data/puffDetect/simulatedPuffs.tif')
        img = test.image
        img = img + 100
        img = img/np.max(img)
        img = img *255
