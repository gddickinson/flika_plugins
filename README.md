# flika_plugins
# Python plugins written for the Parker Lab (https://parkerlab.bio.uci.edu/) and the Pathak Lab (https://www.pathaklab-uci.com/) at UCI to expand FLIKA (https://github.com/flika-org/flika)
