...
class ROI_Base():
    ...
    def makeMenu(self):
        ...
        def distPressed():
            if distAct.text() == "&Plot Distribution":
                self.plotDistribution()
            else:
                self.unplotDistribution()
        ...
        distAct = QtWidgets.QAction("&Plot Distribution", self, triggered=distPressed)
        ...
        def updateMenu():
            ...
            distAct.setText("&Plot Distribution" if self.distWindow == None else "&Unplot Distribution")            
